...
interface
  ...
  type
    ...
    // accesso ao conciliador de movimentações em cartão
    ConciliadorExato = class

      PRIVATE

        ws : WSExato;         // acesso aos webservices
        usuario : string;     // usuário do webservice
      ...
      PUBLIC
         ...
         * texto => o texto da requisição (json ou xml)
         * chave => a chave de 32 caracteres do usuário
         * cliente => o identificador do cliente
         * tipo => o tipo de requisição ("v" para venda, "p" para pagamento)
         * formato => o formato do texto da requisição ("json" ou "xml")
         * retorna a resposta, incluindo o código de erro "e" e uma mensagem explicativa "msg"
         *)
...
implementation
  ...
  begin
     ...
     // preparando os valores da requisição
     ...
     case resp.e of
       1 : resp.msg := 'falha ao conectar à base de dados';
       2 : resp.msg := 'erro no texto da requisição';  
       3 : resp.msg := 'erro no cabeçalho da requisição';  
       4 : resp.msg := 'erro no cabeçalho da requisição';  
       5 : resp.msg := 'o estabelecimento não foi localizado';  
       6 : resp.msg := 'não há informações de adquirentes no período';  
       7 : resp.msg := 'não há registros na requisição';  
       8 : resp.msg := 'cliente não localizado';  
     end;
